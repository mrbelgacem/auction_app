    ...
    def account_generate(request):
        ...
        try:
            ...
            if (request.method == 'POST' and request.data):
                ...
                nameParam = request.GET.get('name')
                commentParam = pubKey=request.GET.get('comment')                
                
            accName = infoAccount.get('name') if ('name' in infoAccount) else nameParam  
            accComment = infoAccount.get('comment') if ('comment' in infoAccount) else commentParam            
